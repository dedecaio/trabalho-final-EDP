...
int main(){
	...
	insereConteudo(&arvore, 40, "Você gosta de natureza ou de áreas mais turísticas? (1 = turística | 2 = natureza)",1);
	...
	insereConteudo(&arvore, 80, "Já que gosta tanto de natureza e quer muito viver perigosamente em trilhas no meio do nada"
		"\n- Estou te recomendando cidades em que você vai amar visitar, de acordo com o que me disse:",0);
